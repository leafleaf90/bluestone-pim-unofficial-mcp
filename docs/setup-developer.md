...
> **Unofficial test deployment:** `https://bluestone-mcp-inofficial.vercel.app/mcp` — available for testing if you don't have your own deployment yet.
...
```json
{
  "mcpServers": {
    "bluestone-pim": {
      "type": "http",
      "url": "https://bluestone-mcp-inofficial.vercel.app/mcp"
    }
  }
}
```
