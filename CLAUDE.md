...
- `list_attribute_definitions`: calls MAPI `/pim/definitions` via `mapiGet()`. Returns shaped attribute definition metadata for browsing and mapping. Enum values are truncated by default.
